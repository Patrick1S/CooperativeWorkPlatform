<template>
  <div id="class">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      <el-breadcrumb-item :to="{ path: '/home' }">Wellcome 项目首页</el-breadcrumb-item>
    ...
    <div>
       ...
       <a><i class="el-icon-sort"></i>&nbsp;&nbsp;课程排序</a>
        ...
        <div>
          <a style="color: #3b3d45; margin-right:900px">置顶项目</a>
        </div>
      ...
      courses: [
        {
          ...
          courseClass: '软工1901',
          courseCode: 'W11111',
          courseYear: '2021-11-20',
          courseTerm: '2021-11-25',
          courseRecentTask: '整理图书1',
          courseLeader: '张吉鑫1',
          coursrBeTop:'置顶',
          projectDescript:'这是图书管理项目1',
        },
       {
          cid: '1',
          courseName: '社区志愿项目2',
        ...
        },
        {
          ...
          courseRecentTask: '整理图书3',
          courseLeader: '张吉鑫3',
          coursrBeTop:'置顶',
          projectDescript:'这是图书管理项目3',
        },
...
.top {
  ...
  background: url('../assets/bkg3.jpg') no-repeat;
  opacity: 80%;
