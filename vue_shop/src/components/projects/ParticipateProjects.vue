<template>
  <div id="class">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>我参与的项目</el-breadcrumb-item>
    ...
    return {
      ...
      courses: [
        ...
        },
        {
          ...
          courseRecentTask: '整理图书2',
          courseLeader: '张吉鑫2',
          coursrBeTop:'置顶',
          projectDescript:'这是图书管理项目2',
        },
        {
          cid: '2',
          courseName: '图书管理项目3',
...
.top {
  ...
  background: url('../../assets/bkg2.jpg') no-repeat;
  opacity: 80%;
